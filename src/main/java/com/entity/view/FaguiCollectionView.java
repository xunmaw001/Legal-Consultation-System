...
public class FaguiCollectionView extends FaguiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String faguiCollectionValue;
	...
	public FaguiCollectionView() {

	}

	public FaguiCollectionView(FaguiCollectionEntity faguiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, faguiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getFaguiCollectionValue() {
				return faguiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setFaguiCollectionValue(String faguiCollectionValue) {
				this.faguiCollectionValue = faguiCollectionValue;
			}
